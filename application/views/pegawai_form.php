<!-- Main content -->
	    ...
	    <tr><td>Id Pegawai <?php echo form_error('id_pegawai') ?></td>
            <td><input readonly type="text" class="form-control" name="id_pegawai" id="id_pegawai" placeholder="Id Pegawai" value="<?php 
            if ($button == "Create") {
              echo gen_id("pe", "pegawai", "id_pegawai", "4", "4");
            }else{
              echo $id_pegawai;
            }
             ?>" />
